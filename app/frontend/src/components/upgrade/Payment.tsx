    ...
    return (
      <div className="flex flex-col items-center py-10">
        ...
        <p className="text-gray-600 text-center mb-8 max-w-md">
          Gracias por tu actualización. Tu paquete {pkg.name} ha sido activado.
        </p>
        <button
          onClick={onComplete}
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
            ...
            <div className="space-y-4 mb-6">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-medium">Tarjeta de crédito / Tarjeta de débito</div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-500">Transferencia directa desde tu cuenta</div>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-medium">Billetera electrónica</div>
            ...
            {paymentMethod === 'bank' && (
              <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                <h4 className="font-medium mb-2">Información de transferencia</h4>
                <p className="text-sm text-gray-600 mb-4">
                  Por favor, transfiere a la siguiente cuenta e ingresa la información de transferencia a continuación:
                </p>
                ...
                <div className="bg-white p-3 rounded border border-gray-200 mb-4">
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="text-gray-500">Número de cuenta:</div>
                    <div className="font-medium">1234567890</div>
                    
                    <div className="text-gray-500">Titular de cuenta:</div>
                    <div className="font-medium">CÔNG TY ABC</div>
                    
                    <div className="text-gray-500">Contenido de transferencia:</div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="flex flex-col items-center mb-4">
                  <div className="mb-4 w-40 h-40 bg-gray-200 rounded-lg flex items-center justify-center">
                    <span className="text-sm text-gray-600">Código QR de pago</span>
                  </div>
                  <p className="text-sm text-gray-600">
                    Escanea el código QR con la aplicación de billetera electrónica para pagar
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 sticky top-6">
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{period} meses</span>
              </div>
            </div>
            ...
            <div className="border-t border-b border-gray-200 py-3 mb-4">
              <div className="flex justify-between text-gray-600">
                ...
                <span>{formatCurrency(pkg.pricingOptions[1].monthlyPrice)} / mes</span>
              </div>
